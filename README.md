...
4. [Quality assurance lections](https://github.com/Alexander-Berg/QA-Useful-Links-and-Cheatcheets/tree/main/Quality%20Assurance%20Lections) - QA lections for study the profession, for personal usage only
...
6. [Artifacts](https://github.com/Alexander-Berg/QA-Useful-Links-and-Cheatcheets/tree/main/Artifacts) - Code and QA artifacts
...
- [DBunit](http://dbunit.sourceforge.net/#:~:text=DbUnit%20is%20a%20JUnit%20extension,known%20state%20between%20test%20runs.&text=DbUnit%20has%20the%20ability%20to,to%20and%20from%20XML%20datasets.)
...
- [Hamcrest](http://hamcrest.org/JavaHamcrest/index) - Assertions for Java
...
- [Java Project Lombok](https://projectlombok.org)
- [AdobtOpenJDK](https://adoptopenjdk.net/index.html?variant=openjdk16&jvmVariant=hotspot)
## Useful Tips & Guides
- [BDD vs TDD](https://dannorth.net/introducing-bdd/)
- [Java Dessign Patterns](https://github.com/iluwatar/java-design-patterns)
- [JavaScpript & Node JS test practices](https://github.com/goldbergyoni/javascript-testing-best-practices)
- [The art of command line](https://github.com/jlevy/the-art-of-command-line)
- [The grand Cheatsheet](https://github.com/chubin/cheat.sh)
- [Modern Javascrypt Tutorial](https://javascript.info)
- [Postman- Grouping requests to collections](https://learning.postman.com/docs/sending-requests/intro-to-collections/)
- [Semantic versioning](https://semver.org)
- [Docker Compose CLI](https://docs.docker.com/compose/reference/)
- [Docker Compose](https://docs.docker.com/compose/)
- [Java Cheatsheet](https://hackr.io/blog/java-cheat-sheet)
- [Hot Keys for IDE's](https://www.jetbrains.com/help/rider/Reference_Keyboard_Shortcuts_Index.html#caret_navigation)
...
- [Hierarchy For Package java.lang](https://docs.oracle.com/javase/8/docs/api/java/lang/package-tree.html)
